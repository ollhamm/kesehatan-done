...
@section('content')
    ...
    @endif
        <div class="mt-4">
            ...
            <button type="button" class="btn mb-3 btn-success" data-bs-toggle="modal" data-bs-target="#createInventarisModal">
                        ...
                        @foreach ($reagensias as $reagensia)
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-warning text-light btn-sm mr-2" data-bs-toggle="modal" data-bs-target="#ediReagentModal{{ $reagensia->id_reagen }}"><i class="fa-solid fa-pen"></i></button>
    ...
    {{-- modal --}}
<div class="modal fade" id="createInventarisModal" tabindex="-1" aria-labelledby="createInventarisModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('reagensia.store') }}" method="POST" novalidate>
                    @csrf
                    <div class="mb-3">
                        <label for="nama_reagen_kit" class="form-label">Nama Reagensia:</label>
                        <input type="text" class="form-control" id="nama_reagen_kit" name="nama_reagen_kit" placeholder="Masukkan nama reagensia" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="reagen_yang_telah_dipakai" name="reagen_yang_telah_dipakai" placeholder="Masukkan jumlah reagen yang telah dipakai" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="ketersediaan" name="ketersediaan" placeholder="Masukkan jumlah ketersediaan" required>
                        <div class="invalid-feedback">
...
@foreach ($reagensias as $reagensia)
    ...
    <div class="modal fade" id="ediReagentModal{{ $reagensia->id_reagen }}" tabindex="-1" aria-labelledby="editReagenModalLabel{{ $reagensia->id_reagen }}" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md"> 
            <div class="modal-content">
                <div class="modal-header">
