                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-warning text-light btn-sm mr-2"
                                        ...
                                        data-bs-target="#editInstrumenModal{{ $instrumen->id_instrumen }}"><i
                                            class="fa-solid fa-pen"></i></button>
                                    <form action="{{ route('admin.instrumen.destroy', $instrumen->id_instrumen) }}"
                                    ...
                                    <a href="{{ route('admin.instrumen.details', $instrumen->id_instrumen) }}"
