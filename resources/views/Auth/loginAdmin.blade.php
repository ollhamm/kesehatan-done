                ...
                <div class="card-body p-5">
                    <div class="row">
                        ...
                        <div class="col-md-3 d-none d-md-block">
                            <img src="{{ asset('images/login_admin.png') }}" alt="Image" class="img-fluid rounded-start">
                        </div>
                        {{-- Konten Kanan --}}
                        <div class="col-md-12 col-md-6">
                            <div class="text-center mb-4">
                                <h2 class="font-weight-bold" style="color: #7fbf7f;">Admin Login</h2>
                            ...
                            <form method="POST" action="{{ route('admin.login') }}">
                                ...
                                <div class="d-grid">
                                    <button type="submit" style="background-color: #7fbf7f" class="btn btn-block text-light">
                                        {{ __('Login') }}
                                    </button>
                                </div>
                            </form>
