                ...
                <div class="card-body p-5">
                    <div class="row">
                        ...
                        <div class="col-md-6 d-none mt-5 d-md-block">
                            <img src="{{ asset('images/register_user.png') }}" alt="Register Image" class="img-fluid rounded-start">
                        ...
                        <div class="col-md-6">
                            <div class="text-center mb-4">
                                <h2 class="font-weight-bold" style="font-weight: bold; color: #84cdde;">Register</h2>
